...
import { View, Text, Alert, StyleSheet, Pressable,
...
docRef.get().then((doc) => {
    if (doc.exists) {
        console.log("Document data:", doc.data().favBusiness);
        if(doc.data().favBusiness===false){
          setFavourite('heart')
        }
        else if(doc.data().favBusiness===true){
          setFavourite('hearto')
        }  
    } else {
