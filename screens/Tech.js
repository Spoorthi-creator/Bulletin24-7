...
import { View, Text, Alert, StyleSheet,  Pressable,TouchableOpacity, FlatList,
...
docRef.get().then((doc) => {
    if (doc.exists) {
        console.log("Document data:", doc.data().favTech);
        if(doc.data().favTech===false){
          setFavourite('heart')
        }
        else if(doc.data().favTech===true){
          setFavourite('hearto')
        }  
    } else {
