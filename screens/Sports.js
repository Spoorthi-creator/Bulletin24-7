...
import { View, Text, Alert, StyleSheet ,TouchableOpacity, FlatList,
...
docRef.get().then((doc) => {
    if (doc.exists) {
        console.log("Document data:", doc.data().favSport);
        if(doc.data().favSport===false){
          setFavourite('heart')
        }
        else if(doc.data().favSport===true){
          setFavourite('hearto')
        }  
    } else {
